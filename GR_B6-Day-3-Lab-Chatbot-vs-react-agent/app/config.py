    ...
    def validate(self):
        ...
        if self.environment == "production":
            if self.agent_api_key == "dev-key-change-me":
                logger.warning("WARNING: AGENT_API_KEY is set to default 'dev-key-change-me' in production!")
            if self.jwt_secret == "dev-jwt-secret":
                logger.warning("WARNING: JWT_SECRET is set to default 'dev-jwt-secret' in production!")
